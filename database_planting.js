// --- DATABASE PENANAMAN & SIPIL TEKNIS ---
...
const db_planting = {
    ...
    years: {
        "tanam_2025": {
            ...
            // Titik Sampling (Dummy untuk contoh)
            points: [
                [-7.705, 112.920, "Pohon"], [-7.706, 112.921, "Pohon"], 
                [-7.707, 112.922, "Rorak"], [-7.708, 112.923, "Sumur"]
            ],
        ...
        "tanam_2024": {
            ...
            stats: { trees: 2500, rorak: 250, sumur: 30 },
            species: { "Sengon": 1500, "Gamelina": 500, "Beringin": 500 },
            points: [
                [-7.710, 112.925, "Pohon"], [-7.712, 112.928, "Pohon"], 
                [-7.711, 112.926, "Rorak"], [-7.713, 112.929, "Rorak"],
                [-7.714, 112.930, "Sumur"]
            ],
        ...
        "tanam_2023": {
            ...
            stats: { trees: 3000, rorak: 200, sumur: 30 },
            species: { "Beringin": 1000, "Aren": 1000, "Bambu": 1000 },
            points: [
                [-7.730, 112.950, "Pohon"], [-7.731, 112.951, "Sumur"], [-7.732, 112.952, "Pohon"]
            ],
        ...
        "tanam_2022": {
            ...
            stats: { trees: 2500, rorak: 150, sumur: 25 },
            species: { "Kopi": 2000, "Lamtoro": 500 },
            points: [ [-7.814, 112.913, "Pohon"], [-7.815, 112.914, "Rorak"] ],
            photos: ["https://via.placeholder.com/400x300?text=Kopi+2022"]
        },
        
        // --- DATA BARU: PROGRAM KONSERVASI AQUA KEBONCANDI 2021 ---
        "tanam_2021": {
            id: "tanam_2021",
            year: 2021,
            location: "Program Konservasi AQUA Keboncandi", // Nama Baru
            desc: "Penanaman massal di area Hutan Lindung Galih dengan berbagai jenis tanaman buah dan kayu.",
            stats: { trees: 5000, rorak: 100, sumur: 20 }, // Jumlah 5000
            species: { "Alpukat": 2000, "Nangka": 1500, "Sukun": 1000, "Lainnya": 500 },
            
            // Titik Sampling (Diambil dari GeoJSON Anda - Sebagian)
            // Format: [Lat, Lng, Tipe]
            points: [
                [-7.822741, 112.905788, "Pohon"], [-7.806920, 112.909211, "Pohon"], [-7.806136, 112.902091, "Pohon"],
                [-7.817353, 112.915786, "Pohon"], [-7.817128, 112.914718, "Pohon"], [-7.808558, 112.909899, "Pohon"],
                [-7.806008, 112.908983, "Pohon"], [-7.817486, 112.915908, "Pohon"], [-7.805980, 112.909091, "Pohon"],
                [-7.819303, 112.912475, "Pohon"], [-7.806041, 112.908911, "Pohon"], [-7.808586, 112.909891, "Pohon"],
                [-7.805813, 112.909155, "Pohon"], [-7.805713, 112.909085, "Pohon"], [-7.805905, 112.909266, "Pohon"],
                [-7.819354, 112.912425, "Pohon"], [-7.805238, 112.906371, "Pohon"], [-7.817628, 112.915946, "Pohon"],
                [-7.805738, 112.908913, "Pohon"], [-7.817471, 112.915211, "Pohon"], [-7.816678, 112.914268, "Pohon"],
                [-7.808461, 112.909853, "Pohon"], [-7.806936, 112.909365, "Pohon"], [-7.805498, 112.909190, "Pohon"],
                [-7.805941, 112.908950, "Pohon"], [-7.806157, 112.901298, "Pohon"], [-7.806356, 112.901705, "Pohon"],
                [-7.806358, 112.901766, "Pohon"], [-7.806409, 112.901791, "Pohon"], [-7.805971, 112.901406, "Pohon"],
                [-7.806013, 112.901896, "Pohon"], [-7.806086, 112.902113, "Pohon"], [-7.806381, 112.901544, "Pohon"],
                [-7.806751, 112.901418, "Pohon"], [-7.806370, 112.901741, "Pohon"], [-7.805953, 112.901450, "Pohon"]
            ],

            // Polygon Area Konservasi (Hutan Lindung)
            // Format: [Lat, Lng] (Dibalik dari GeoJSON agar sesuai Leaflet)
            polygon: [
            ...
            photos: ["https://via.placeholder.com/400x300?text=Galih+2021", "https://via.placeholder.com/400x300?text=Alpukat+2021"]
        }
    }
};
