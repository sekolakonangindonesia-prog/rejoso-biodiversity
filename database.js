// --- DATABASE SIS-KEHATI REJOSO (REVISI KOMPLIT) ---
...
const db_kehati = {
    ...
    polygons: {
        ...
        "features": [
            // TAMAN 1 (BIRU)
            { 
                "type": "Feature", "properties": { "name": "Taman 1", "id_lokasi": "kehati_aqua", "color": "#29b6f6" },
            ...
            // TAMAN 2 (MERAH)
            { 
                "type": "Feature", "properties": { "name": "Taman 2", "id_lokasi": "kehati_aqua", "color": "#ef5350" },
            ...
            // TAMAN 3 (KUNING)
            { 
                "type": "Feature", "properties": { "name": "Taman 3", "id_lokasi": "kehati_aqua", "color": "#fbc02d" },
    ...
    // 2. DATA DETAIL (ANGKA & GRAFIK LENGKAP)
    locations: {
        "kehati_aqua": {
            ...
            hasPolygon: true,
            headerImage: "header_kehati.jpg", // Pastikan file ada di GitHub

            // ANGKA TERKINI (2025)
            indices: { H: 3.99, E: 0.87, R: 15.72, cat: "Sangat Tinggi" },
            
            // GRAFIK HISTORIS (POHON)
            historyH: [3.41, 3.47, 3.65, 3.74, 3.79, 3.99],
            historyE: [0.81, 0.82, 0.84, 0.85, 0.86, 0.87], // Dummy data (edit jika ada real)
            historyR: [14.2, 14.5, 14.8, 15.1, 15.4, 15.72], // Dummy data

            // GRAFIK SPESIES (2020-2025)
            floraStats: { 
                total: 203, famili: 75, 
                years: ['2020', '2021', '2022', '2023', '2024', '2025'],
                values: [136, 156, 172, 201, 223, 203] // Penurunan di 2025
            },
            ...
            // GRAFIK BURUNG (2020-2025)
            birdTrend: [20, 22, 24, 25, 27, 26], 
        ...
        "galih_pecaton": {
            ...
            headerImage: "header_pecaton.jpg", // Upload foto ini

            indices: { H: 3.11, E: 0.79, R: 7.93, cat: "Tinggi" },
            historyH: [2.60, 3.11], historyE: [0.75, 0.79], historyR: [5.30, 7.93], // Data PDF
            ...
            birdTrend: [25, 25], // Data Burung

            protectedList: [
                { name: "Bubut Jawa (Centropus nigrorufus)", status: "IUCN: VU | Endemik", type: "Fauna", img: "bubut_jawa.jpg" },
                { name: "Tupai Kekes (Tupaia javanica)", status: "IUCN: LC", type: "Fauna", img: "tupai_kekes.jpg" }
            ],
        ...
        "galih_karyono": {
            ...
            historyH: [2.74], historyE: [0.99], historyR: [4.03],
        ...
        "galih_andari": {
            ...
            historyH: [2.72, 2.75], historyE: [0.98, 0.99], historyR: [4.15, 4.18],
        ...
        "umbulan": {
            ...
            historyH: [3.5], historyE: [0.85], historyR: [12.1],
        ...
        "nguling": {
            ...
            historyH: [2.9], historyE: [0.7], historyR: [5.5],
